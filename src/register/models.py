...
class CustomUser(AbstractUser):
    ...
    POSTAL_CD_VALID = RegexValidator(regex=r'^[0-9]{7}+$', message=('半角数字7桁で入力してください'))
    # 既存カラムの上書き
    ...
    # 追加フィールド
    gender = models.CharField(null=True, blank=True, max_length=1, choices=GENDER_CHOICES, default='0', verbose_name='性別')
    tel_number = models.CharField(validators=[TEL_NUM_VALID], max_length=15, blank=True, verbose_name='電話番号')
    postal_cd = models.CharField(validators=[POSTAL_CD_VALID], max_length=15, blank=True, verbose_name='郵便番号')
