...
class AccessHistory(models.Model):
    ...
    created_user = models.ForeignKey(get_user_model(), to_field='id', on_delete=models.SET_NULL, null=True, related_name='access_creater', verbose_name='作成者')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='更新日時')
    updated_user = models.ForeignKey(get_user_model(), to_field='id', on_delete=models.SET_NULL, null=True, related_name='access_updater', verbose_name='更新者')
