    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_code', models.CharField(max_length=255, validators=[django.core.validators.RegexValidator('^[0-9A-Za-z_-]+$', '半角英数字・ハイフン・アンダースコアのみ使用できます。')], verbose_name='商品コード')),
            ...
            options={
                'ordering': ['product_code', 'start_date'],
            },
        ),
        migrations.CreateModel(
